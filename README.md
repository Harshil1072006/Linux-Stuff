...
A complete reference for Bash scripting fundamentals, advanced techniques, and real-world projects.
...
- [User Interaction](#user-interaction--operations)
- [Control Flow](#control-flow)
- [Advanced Scripting](#advanced-scripting)
- [Scripting Projects](#scripting-projects)
...
| **Examples:** Windows, macOS, Linux distributions (Ubuntu) | **Examples:** Linux Kernel, Windows NT Kernel |
...
A shebang is the first line in a script, which tells the system what interpreter to use to execute the script.
...
**Read-only Variables:** Cannot have their value changed once set.
```bash
...
Arrays hold multiple values separated by spaces.
...
### Project 6: Check System Service Status Report
...
### Project 7: Call a Public API and Parse JSON
...
### Project 8: Sync Files Between Directories
...
### Project 10: Schedule Automated Tasks with Cron
...
touch $my_file # This creates THREE files: "File", "with", "spaces.txt"
touch "$my_file" # This correctly creates ONE file: "File with spaces.txt"
```

### Command Substitution

Command substitution allows you to use the output of a command as part of another command or as a value for a variable. The `$(...)` syntax is modern and preferred because it can be nested easily.
...
Parameter expansion can do much more than basic variable access.
...
`cron` is the standard for scheduling recurring scripts. Use `crontab -e` to edit your cron jobs.
